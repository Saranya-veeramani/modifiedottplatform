...
import image from'../asserts/maxresdefault.jpg';
...
const MovieSlider = ({ movies, handleMovieClick }) => {
  ...
  const settings = {
    dots: true,              // Show the dots pagination
    ...
    responsive: [
      {
        ...
        settings: {
          ...
          slidesToScroll: 1, // Scroll 1 slide at a time on mobile devices
        },
      },
    ],
  };
...
const HomePage = () => {
  ...
  return (
    <div>
      {imageUrl && (
        <Box className={classes.banner} style={{backgroundImage:'../asserts/maxresdefault.jpg'}}>
